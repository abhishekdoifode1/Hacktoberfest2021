...
while(1):
    ...
    try:
            ...
            # scoreboard
            score=cv2.imread('D:/Virtual-Hand-Cricket/models/black.jpg')
            score=score[0:800, 0:800]
            score= cv2.putText(score,"Scoreboard", (90,30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255,0))
            score= cv2.line(score, (70,35), (300,35), (0,255,0), 1)
            score= cv2.line(score, (145,35), (145,80), (0,255,0), 1)
            ...
            if  cv2.waitKey(10) & 0xFF == ord('h'):
                ...
                if player is False: # i.e. player will bat first
                    ...
                    if player_num == bot_num:
                        ...
                        score=cv2.putText(score,"{}".format(player_num), (90,65), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0,255,0), 4)
                        score=cv2.putText(score,"{}".format(bot_num), (160,65), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0,255,0), 4)
    
                        score=cv2.putText(score,"Player is out!", (100,90), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255,0,0))
                        score= cv2.putText(score,"Bot will bat now!", (100, 115), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255,0,0))
                        player_status = True
                        player = True
                        bot = False
                        ...
                        score= cv2.putText(score,"Player score: {}".format(player_score),(90, 85), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255,0,0))
                    ...
                    if bot_num == player_num:
                        ...
                        score= cv2.putText(score,"Bot is out!",(100,90), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255,0,0))
                        bot_status = True
                        ...
                        cv2.putText(frame,"player_score:{}".format((player_num)), (10,20), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0,255,0), 4)
                        cv2.putText(frame,"bot_score:{}".format((bot_num)), (500, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0,255,0), 4)
                        text="Bot score: ".join(str(bot_score))
                        score= cv2.putText(score,"Bot score: {}".fomat(bot_score),(160, 85), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255,0,0))
    ...
    if player_status == True:           
        ...
        # print(Game_status)
        score=cv2.putText(score,"Game_status:{}".format(str(Game_status)), (20, 200), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 4)
        if bot_status == False:
            Game_status="Bot will bat now!"                                   
            # print(Game_status)
            score=cv2.putText(score,"Game_status:{}".format(str(Game_status)), (20, 250), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 4)
    if bot_status == True:           
        Game_status="BOT OUT !"                 
        # print(Game_status)
        score=cv2.putText(score,"Game_status:{}".format(str(Game_status)), (20, 300), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 4)
        if player_score > bot_score:
            Game_status="Player wins the game ....."
            # print(Game_status)
            score=cv2.putText(score,"Game_status:{}".format(str(Game_status)), (20, 350), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 4)
        else:
            Game_status="Bot wins the game ....."
            # print(Game_status)                
            score=cv2.putText(score,"Game_status:{}".format(str(Game_status)), (20, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 4)
    #show the windows
